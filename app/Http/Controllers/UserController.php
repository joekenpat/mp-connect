...
class UserController extends Controller
{
  public function updatePersonalInfo(Request $request)
  {
    $request->validate([
      ...
      'mobile_phone' => 'sometimes|nullable|string|max:15|min:8|unique:users',
      'fixed_phone' => 'sometimes|nullable|string|max:15|min:8|unique:users',
      'countries_of_work_experience' => 'sometimes|nullable|numeric|integer|between:0,10',
      'countries_of_work_experience' => 'sometimes|nullable|numeric|integer|between:0,10',
